...
export default function Dashboard() {
  ...
  const yieldData = {
    totalYield: isConnected ? "$243.67" : "-",
    currentAPY: isConnected ? "5.2%" : "-",
    changeFromLastMonth: isConnected ? "+0.3% from last month" : "-",
  };

  const vaultData = {
    drift: {
      percentage: isConnected ? 40 : 0,
      apy: isConnected ? "6.8%" : "-",
      amount: isConnected ? "757.03 zUSD" : "-",
      color: "var(--indigo-11)",
    },
    kamino: {
      percentage: isConnected ? 35 : 0,
      apy: isConnected ? "4.9%" : "-",
      amount: isConnected ? "662.40 zUSD" : "-",
      color: "var(--purple-11)",
    },
    zUSDPool: {
      percentage: isConnected ? 25 : 0,
      apy: isConnected ? "3.2%" : "-",
      amount: isConnected ? "473.14 zUSD" : "-",
      color: "var(--violet-11)",
    },
  };
        ...
        <Container mx="auto" size="3">
          <Flex justify="between" align="center">
            ...
            <Button
              ...
              onClick={isConnected ? handleOpenChargeModal : undefined}
